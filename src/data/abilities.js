...
export const ABILITIES = {
  ...
  sunburst: {
    ...
    mech: 'surge', boost: 1.25, power: 1.06, guard: 4.0,
  ...
  cruiser: {
    ...
    mech: 'recover', repair: true, boost: 1.3, power: 1.07,
  },
  violetta: {
  ...
  goldrush: {
    ...
    mech: 'utility', magnet: { time: 11.0, radius: 30 },
  },
  ...
  inferno: {
    ...
    mech: 'wave', wave: { radius: 17, force: 34 },
  },
};
